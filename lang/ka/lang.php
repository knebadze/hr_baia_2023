...
return [
    ...
    */
    ...
    'forgot_password_btn' => 'კოდის გაგზავნა',
    'check_code_btn' => 'კოდის შემოწმება',
    'change_password_btn' =>'პაროლის შეცვლა',
    // ----------------------------------------------------------------------------------------------------
    // Title Lang
    ...
    'welcome_leftside_bar_firstword_two' => 'მოიძებნება',
    'welcome_leftside_bar_firstword_three'=> 'ყველასთვის...',
    ...
    // ----------------------------------------------------------------------------------------------------
    // Current vacancies
    'welcome_current_vacancies_title' => 'მიმდინარე ვაკანსიები',
    'welcome_popular_vacancies_title' => 'პოპულარული ვაკანსიები',
    'welcome_current_vacancies_button' => 'ყველას ნახვა',
    ...
    // Footer Nav
    'footer_nav_faq' => 'ხდკ',
        'footer_nav_large' => 'ხშირად დასმული კითხვები',
    'prices' => 'ფასები',
    'rule' => 'წესები და პირობები',
    ...
    // Prices Page
    'conditions_for_the_candidate' => 'პირობები კანდიდატს',
    'conditions_for_the_candidate_modal' => '🌹ჩვენი პირობები შემდგომში მდგომარეობს:
                                            პირველი თვის ანაზღაურებიდან ნახევარი ჩამოგეჭრებათ,
    ...
    'conditions_for_the_employer' => 'პირობები დამქირავებელს',
    'conditions_for_the_employer_modal' => '🌹ჩვენ შემოგთავაზებთ თქვენს მოთხოვნებთან მაქსიმალურ
                                            შესაბამისობაში მოყვანილ 4-5 კანდიდატს მათი ასაკის, საცხოვრებელი ადგილის,
                                            განათლების, უცხო ენის ცოდნის იქნება ეს თუ ნებისმიერი სხვა თქვენს მიერ მოთხოვნილი
                                            პარამეტრებითა და სათანადო ცნობებით, გაგასაუბრებთ მათ ჩვენთან ოფისში მოისურვებთ,
                                            თქვენთან ოჯახში თუ დისტანციურად როგორც თქვენთვის უფრო კომფორტული იქნება და რომელიმეს
                                            მოწონებისა და 1 კვირიანი გამოსაცდელი ვადის წარმატებით გავლის შემთხვევაში ჩვენთან იხდით
                                            კადრის მოძიების საფასურად თქვენს მიერ დასახელებული თვიური ხელფასის მხოლოდ 10%-ს ერთჯერადად,
                                            რაშიაც შედის 1 წლის განმავლობაში კადრი თუ წავიდა სამსახურიდან მისგან დამოუკიდებელი მიზეზების
                                            გამო ან თავად დაითხოვეთ - 3 ჯერ უფასოდ ჩაგინაცვლებთ სხვა ალტერნატიული კანდიდატურით,
                                            ხოლო დასაქმებული კანდიდატი კი იხდის პირველი თვის ანაზღაურებიდან 50%-ს, რომელი თანხის
                                            წარმოდგენის უზრუნველყოფის ვალდებულებაც გეკისრებათ თქვენ რადგან ასე ვთქვათ ,თქვენი ხელიდან გადის“
                                            მასთან ეს თანხა და თვის ბოლო რომ დადგება ნახევარს აძლევთ მას/კანდიდატს, რის შესახებაც რათქმაუნდა
                                            ინფორმირებული და თანახმანი არიან თვით კანდიდატებიც.',


    'prices_text_descr' => 'თქვენს ყურადღებას იმაზე გავამახვილებთ,
                            რომ სააგენტო არ საზღვრავს ამათუიმ საქმიანობის საფასურს,
                            აღნიშნული არის დღევანდელი საერთო საბაზრო ღირებულებიდან გამომდინარე,
                            როგორც საოჯახო ასევე ყველა, სხვა ზემოთჩამოთვლილი პერსონალის საქმიანობის სფეროში.',

    'validation_error' => [
        'required' => 'შევსება სავალდებულოა',
        'email' => 'გთხოვთ შეავსოთ ელ. ფოსტის ფორმატში',
        'numeric' => 'უნდა შეიცავდეს მხოლოდ ციფრების',
    ],
