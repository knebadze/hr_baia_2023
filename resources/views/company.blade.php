                    ...
                    <div class="col-lg-4 col-md-12 rightSidebar">
                        ...
                        <div class="side-bar">
                            ...
                            <div class="sidebar-elements search-bx">
                                ...
                                <form>
                                    ...
                                    <div class="form-group mb-4 categorySideBar">
                                        <h4 class="section-head-small mb-4">{{ __('lang.company_vacancies_page_leftside_category') }}</h4>
                                        <select class="wt-select-bar-large selectpicker"  data-live-search="true" data-bv-field="size">
                                            <option selected>{{ __('lang.company_vacancies_page_leftside_category_allcategory') }}</option>
                                            <option>ძიძა</option>
                                    ...
                                    <div class="form-group mb-4 keywordSideBar">
                                        <h4 class="section-head-small mb-4">{{ __('lang.company_vacancies_page_leftside_keyword') }}</h4>
                                        <div class="input-group">
                                            <input type="text" class="form-control" placeholder="{{ __('lang.company_vacancies_page_leftside_name_or_keyword') }}">
                                            <button class="btn" type="button"><i class="feather-search"></i></button>
                                        </div>
                                    </div>

                                    <div class="form-group mb-4 locationSideBar">
                                        <h4 class="section-head-small mb-4">{{ __('lang.company_vacancies_page_leftside_location') }}</h4>
                                        <div class="input-group">
                                            <input type="text" class="form-control" placeholder="{{ __('lang.company_vacancies_page_leftside_search_location') }}">
                                            <button class="btn" type="button"><i class="feather-map-pin"></i></button>
                                        </div>
                                    </div>

                                    <div class="twm-sidebar-ele-filter jobTypeSideBar">
                                        <h4 class="section-head-small mb-4">{{ __('lang.company_vacancies_page_leftside_type_of_work') }}</h4>
                                        <ul>
                                            <li>
                                    ...
                                    <div class="twm-sidebar-ele-filter publicationSideBar">
                                        <h4 class="section-head-small mb-4">{{ __('lang.company_vacancies_page_leftside_date_of_publication') }}</h4>
                                        <ul>

                                            <li>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="examplecheckbox6">
                                                    <label class="form-check-label" for="examplecheckbox6">{{ __('lang.company_vacancies_page_leftside_any') }}</label>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="examplecheckbox1">
                                                    <label class="form-check-label" for="examplecheckbox1">{{ __('lang.company_vacancies_page_leftside_last_24') }}</label>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="examplecheckbox2">
                                                    <label class="form-check-label" for="examplecheckbox2">{{ __('lang.company_vacancies_page_leftside_last_3') }}</label>
                                                </div>
                                            </li>
                                            ...
                                            <li>
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label" for="examplecheckbox3">{{ __('lang.company_vacancies_page_leftside_last_7') }}</label>
                                                </div>
                                            </li>
                                    ...
                                    <div class="twm-sidebar-ele-filter sallarySideBar">
                                        <h4 class="section-head-small mb-4">{{ __('lang.company_vacancies_page_leftside_sallary') }}</h4>
                                        <ul>
                                            <li>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="Any1">
                                                    <label class="form-check-label" for="Any1">{{ __('lang.company_vacancies_page_leftside_sallary_any') }}</label>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="Compensation1">
                                                    <label class="form-check-label" for="Compensation1">{{ __('lang.company_vacancies_page_leftside_sallary_from_500') }}</label>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="Compensation2">
                                                    <label class="form-check-label" for="Compensation2">{{ __('lang.company_vacancies_page_leftside_sallary_from_700') }}</label>
                                                </div>
                                            </li>
                                            ...
                                            <li>
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label" for="Compensation3">{{ __('lang.company_vacancies_page_leftside_sallary_from_900') }}</label>
                                                </div>
                                            </li>
                                            ...
                                            <li>
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label" for="Other1">{{ __('lang.company_vacancies_page_leftside_sallary_other') }}</label>
                                                </div>
                                            </li>

                                            <div class="twm-sidebar-ele-filter sheduldeSideBar">
                                                <h4 class="section-head-small mb-4">{{ __('lang.company_vacancies_page_leftside_shedulde') }}</h4>
                                                <ul>
                                                    <li>
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="AnySchedule1">
                                                            <label class="form-check-label" for="AnySchedule1">{{ __('lang.company_vacancies_page_leftside_shedulde_any') }}</label>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="DaySchedule1">
                                                            <label class="form-check-label" for="DaySchedule1">{{ __('lang.company_vacancies_page_leftside_shedulde_day') }}</label>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="Compensation2">
                                                            <label class="form-check-label" for="Compensation2">{{ __('lang.company_vacancies_page_leftside_shedulde_night') }}</label>
                                                        </div>
                                                    </li>
                                                    ...
                                                    <li>
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="Compensation3">
                                                            <label class="form-check-label" for="Compensation3">{{ __('lang.company_vacancies_page_leftside_shedulde_daily') }}</label>
                                                        </div>
                                                    </li>
                                                    ...
                                                    <li>
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="Other1">
                                                            <label class="form-check-label" for="Other1">{{ __('lang.company_vacancies_page_leftside_shedulde_other') }}</label>
                                                        </div>
                                                    </li>
                                            ...
                                            <div class="twm-sidebar-ele-filter">
                                                <h4 class="section-head-small mb-4">{{ __('lang.company_vacancies_page_leftside_second_location') }}</h4>
                                                <ul>
                                                    <li>
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="AnyLocation1">
                                                            <label class="form-check-label" for="AnyLocation1">{{ __('lang.company_vacancies_page_leftside_second_location_any') }}</label>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="FromLocation1">
                                                            <label class="form-check-label" for="FromLocation1">{{ __('lang.company_vacancies_page_leftside_second_location_3km') }}</label>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="FromLocation2">
                                                            <label class="form-check-label" for="FromLocation2">{{ __('lang.company_vacancies_page_leftside_second_location_5km') }}</label>
                                                        </div>
                                                    </li>
                                                    ...
                                                    <li>
                                                        <div class="form-check">
                                                            ...
                                                            <label class="form-check-label" for="FromLocation3">{{ __('lang.company_vacancies_page_leftside_second_location_7km') }}</label>
                                                        </div>
                                                    </li>
                            ...
                            <div class="widget tw-sidebar-tags-wrap">
                                <h4 class="section-head-small mb-4">{{ __('lang.company_vacancies_page_leftside_tags') }}</h4>
                        ...
                        <div class="twm-advertisment" style="background-image:url(/images/add-bg.jpg);">
                           ...
                           <p>{{ __('lang.company_vacancies_page_leftside_box_title') }} </p>
                            <a href="about-1.html" class="site-button white">{{ __('lang.company_vacancies_page_leftside_box_read_more') }}</a> 
                        </div>
                        ...
                        <div class="product-filter-wrap d-flex justify-content-between align-items-center m-b30">
                            ...
                            <form class="woocommerce-ordering twm-filter-select" method="get">
                                ...
                                <select class="wt-select-bar-2 selectpicker"  data-live-search="true" data-bv-field="size">
                                    ...
                                    <option>{{ __('lang.company_vacancies_page_middle_full_time') }}</option>
                                    <option>{{ __('lang.company_vacancies_page_middle_intership') }}</option>
                                    <option>{{ __('lang.company_vacancies_page_middle_half_time') }}</option>
                                    <option>{{ __('lang.company_vacancies_page_middle_temporary') }}</option>
                                </select>
                                <select class="wt-select-bar-2 selectpicker"  data-live-search="true" data-bv-field="size">
                                    <option>{{ __('lang.company_vacancies_page_middle_show_me_10') }}</option>
                                    <option>{{ __('lang.company_vacancies_page_middle_show_me_20') }}</option>
                                    <option>{{ __('lang.company_vacancies_page_middle_show_me_30') }}</option>
                                    <option>{{ __('lang.company_vacancies_page_middle_show_me_40') }}</option>
                                    <option>{{ __('lang.company_vacancies_page_middle_show_me_50') }}</option>
                                    <option>{{ __('lang.company_vacancies_page_middle_show_me_60') }}</option>
                                </select>
                            </form>
                            ...
                            <div class="col-lg-6 col-md-12 m-b30">
                                ...
                                <div class="twm-jobs-grid-style1">
                                    ...
                                    <div class="twm-right-content">
                                        ...
                                        <a href="job-detail.html" class="twm-jobs-browse site-text-primary">{{ __('lang.company_vacancies_page_middle_leftside_read_more') }}</a>
                                    </div>
                                </div>
