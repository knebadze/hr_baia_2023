                ...
                <div class="col-xl-3 col-lg-4 col-md-12 rightSidebar m-b30">
                    <div class="side-bar-st-1">
                        ...
                        <div class="twm-nav-list-1">
                            <ul>
                                <li><a href="{{ route('home' , App()->getLocale())  }}"><i class="fa fa-tachometer-alt"></i> Dashboard</a></li>
                                <li class="active"><a href="{{ route('candidateProfile' , App()->getLocale())  }}"><i class="fa fa-user"></i> My Pfofile</a></li>
