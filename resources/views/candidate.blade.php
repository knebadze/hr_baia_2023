                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label" for="exampleradio1">{{ __('lang.candidate_page_leftside_last_24') }}</label>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="form-check">
                                                    <input type="radio" class="form-check-input" id="exampleradio2">
                                                    <label class="form-check-label" for="exampleradio2">{{ __('lang.candidate_page_leftside_last_3') }}</label>
                                                </div>
                                            </li>
                                            ...
                                            <li>
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label" for="exampleradio3">{{ __('lang.candidate_page_leftside_last_7') }}</label>
                                                </div>
                                            </li>
