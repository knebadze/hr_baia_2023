<template lang="">
    ...
    <!-- <section class="content ">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-12">
                                    <div class="form-group">
                                        <label>მაილი</label>
                                        <div class="ls-inputicon-box">
                                            <input class="form-control" v-model="m.email"  type="text" placeholder="01234567890" onkeypress="return event.which != 32">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12">
        ...
        <employer_table :data="employer" :role_id="data.role_id" :key="employer.length"></employer_table>
        <div class="mt-2">
            <paginate
