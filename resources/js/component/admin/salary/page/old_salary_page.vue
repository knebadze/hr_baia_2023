<template lang="">
    <div>
                ...
                <div class="card card-primary" >
                    ...
                    <div id="collapseOne" class="collapse hide"  data-parent="#accordion" >
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="col-xl-4 col-lg-6 col-md-12" v-if="role_id == 1">
                                    <div class="form-group">
                                        <label>ჰრ</label>
                                        <div class="ls-inputicon-box">
                                            <multiselect v-model="m.hr"  :options="hr" :multiple="true" :close-on-select="false" :clear-on-select="false" :preserve-search="true"  label="name_ka" track-by="name_ka" :preselect-first="false" >
                                ...
                                <div :class="role_id == 1?'col-xl-4 col-lg-6 col-md-12':'col-xl-6 col-lg-6 col-md-12'" >
                                    <div class="form-group">
                                        <label> თვე (დან)</label>
                                        <div class="ls-inputicon-box">
                                            <month-picker-input @change="fromDate"  :no-default="true" class="pick"></month-picker-input>
                                        </div>
                                    </div>
                                </div>
                                <div :class="role_id == 1?'col-xl-4 col-lg-6 col-md-12':'col-xl-6 col-lg-6 col-md-12'">
        ...
        <hr>
        <old_salary_table :data="items" :role_id="role_id" :key="tableKey"> </old_salary_table>
    </div>
</template>
<script>
...
export default {
    ...
    methods: {
        fromDate(date){
            const parsedDate = moment(date.from.toDateString(), 'ddd MMM DD YYYY');
            this.date[0] = parsedDate.format('DD-MM-YYYY');
        },
        toDate(date){
            const parsedDate = moment(date.to.toDateString(), 'ddd MMM DD YYYY');
