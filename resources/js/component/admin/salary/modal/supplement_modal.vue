    ...
    <div v-if="showConfirm" class="modal fade show" tabindex="-1"  role="dialog" aria-labelledby="exampleModalCenterTitle" id="modalMap"  aria-hidden="true" style="display:block">
          <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
              ...
              <div class="modal-header">
                  <h6 class="modal-title" id="exampleModalLongTitle">{{ item.hr.user.name_ka }}ს ხელფასისი დანამატი</h6>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-12">
                        <div class="form-group">
                            ...
                            <div class="ls-inputicon-box">
                                <input class="form-control" v-model="m.full_salary" type="number" placeholder="0" disabled>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-6 col-md-12">
                        <div class="form-group">
                            ...
                            <div class="ls-inputicon-box">
                                <input class="form-control" v-model="m.supplement" type="number" placeholder="0" step="10" @input="supplement(m.supplement)">
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-6 col-md-12">
                        <div class="form-group">
                            ...
                            <div class="ls-inputicon-box">
                                <input class="form-control" v-model="m.total_salary" type="number" placeholder="0" step="10" disabled>
                            </div>
                        </div>
                    </div>
