...
<div v-if="showConfirm" class="modal fade show" tabindex="-1"  role="dialog" aria-labelledby="exampleModalCenterTitle" id="modalMap"  aria-hidden="true" style="display:block">
   <div class="modal-dialog modal-dialog-centered modal-xl modal-dialog-scrollable" role="document">
       ...
       <div class="modal-header">
           <h6 class="modal-title" id="exampleModalLongTitle">სრულად ნახვა და რედაქტირება</h6>
       ...
       <div  class="modal-footer">
           <button type="button" class="btn btn-success" @click="updateHR(model)" ><i class=""></i>განახლება</button>
       </div>
       </div>
   </div>
</div>
