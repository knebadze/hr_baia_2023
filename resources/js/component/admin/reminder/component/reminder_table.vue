<template lang="">
            ...
            <tbody>
                <tr v-for="(item, index) in tableData" :key="index">
                    ...
                    <td>
                        <u
                            class="text-primary"
                            @click="vacancyModal(item.vacancy_id)"
                            >{{ item.code }}</u
                        >
                    </td>
                    ...
                    <td>
                        <div v-if="role_id == 2">
                            <button
                                ...
                                v-if="item.status == 1"
                            >
                                <i class="fa fa-check-square"></i> შევასრულე
                            </button>
                        </div>
                        <div v-else>
                            <button
    ...
    <filledReminder
        :visible="reminderModelShow"
        :item="modalItem"
    ></filledReminder>
    <vacancyFullInfoModal
        :visible="vacancyModelShow"
        :vacancyId="vacancyId"
    ></vacancyFullInfoModal>
    <reminderEdit
        :visible="reminderEditModelShow"
        :item="modalItem"
    ></reminderEdit>
</template>
<script>
