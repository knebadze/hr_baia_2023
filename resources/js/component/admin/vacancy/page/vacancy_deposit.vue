                    ...
                    <div class="row py-3 border border-success">
                        ...
                        <div class=" col-md-12">
                            <div class="form-group">
                                <label>ქვითარი </label>
                                <div class="ls-inputicon-box">
                                    <input class="form-control" type="file" ref="fileInput" @change="handleEmployerFileChange">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <button v-if="m.must_be_enrolled_employer_date" type="button" class="btn btn-primary float-right" @click.prevent="save()" ><i class=""></i>ჩარიცხვა</button>
                        </div>
...
export default {
    ...
    methods:{
        handleEmployerFileChange(event) {
            this.fileEmployer = event.target.files[0];
            this.enrollmentEmployer.file_name = this.fileEmployer.name
        },
        forItem(item){
            var editedFields = {}
