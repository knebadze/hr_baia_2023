<template lang="">
    <div>
        <div v-if="enrollment" class="alert alert-info alert-dismissible">
            ...
            ამ ვაკანსიაზე თქვენ ელოდებით თანხის <u>{{ ( enrollment.type == 0)?'არასრული':'სრული' }}</u> ჩარიცხვის დადასტურებას.
            <ul>
        ...
        <div class="row py-3 border border-success">
            ...
            <div class="row col-md-12" v-if="m.must_be_enrolled != 0">
                <div class=" col-xl-6 col-lg-6 col-md-12">
                    <div class="form-group">
                        <label>{{ title }}  <span class="text-danger">სულ </span>უნდა ჩაირიცხოს</label>
                        <div class="ls-inputicon-box">
                            <input class="form-control" v-model="m.initial_amount" type="number" placeholder="0" >
                        </div>
                    </div>
                </div>
                <div class=" col-xl-6 col-lg-6 col-md-12">
                    <div class="form-group">
                        ...
                        <div class="ls-inputicon-box">
                            <input class="form-control" v-model="m.must_be_enrolled_date" type="date" >
                        </div>
                    </div>
                </div>
                <div class=" col-md-12">
                    <div class="form-group">
                        ...
                        <div class="ls-inputicon-box">
                            <input class="form-control" v-model="m.must_be_enrolled" type="number" placeholder="0" disabled>
                        </div>
                    </div>
                </div>
                <div class="col-md-12" >
                ...
                <div class="row col-md-12" v-if="status == 3 &&  m.must_be_enrolled != null">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12">
                        <div class="form-group">
                            ...
                            <div class="ls-inputicon-box">
                                <input class="form-control" v-model="model.money" type="number" placeholder="0" >
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-12">
                    ...
                    <div class="col-md-12">
                        <button v-if="!enrollment" type="button" class="btn btn-primary float-right" @click.prevent="counting(model)" ><i class=""></i>ჩარიცხვა</button>
                    </div>
                </div>
            ...
            <div v-else class=" col-md-12">
                <div class="form-group">
                    ...
                    <div class="ls-inputicon-box">
                        <input class="form-control" v-model="m.initial_amount" type="number" placeholder="0" disabled>
                    </div>
                </div>
            </div>
...
export default {
    ...
    setup(props, { emit }) {
        ...
        const title = ref(props.type == 'candidate' ? 'კანდიდატისგან' : 'დამსაქმებლისგან')
            ...
            if (enrollmentType == 0) {
                ...
                Swal.fire({
                    ...
                    preConfirm: () => {
                        ...
                        .catch(error => {
                            Swal.fire.showValidationMessage(`Request failed: ${error}`);
                        });
                    },
