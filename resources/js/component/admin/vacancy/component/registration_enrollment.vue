            ...
            <div class="row col-md-12" v-if="m.enroll_date">
                <div class=" col-xl-6 col-lg-6 col-md-12">
                    <div class="form-group">
                        <label>რეგისტრაციის  <span class="text-danger">სულ </span>უნდა ჩაირიცხოს</label>
                ...
                <div class="col-xl-6 col-lg-6 col-md-12">
                    <div class="form-group">
                        ...
                        <div class="ls-inputicon-box">
                            <input class="form-control" v-model="m.money" type="number" placeholder="0" >
                        </div>
                    </div>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-12">
                    <div class="form-group">
                        ...
                        <div class="ls-inputicon-box">
                            <input class="form-control" v-model="m.name" type="text" placeholder="0" >
                        </div>
                    </div>
                </div>
                <div class=" col-md-12">
                ...
                <div class="col-md-12">
                    <button v-if="!registerInfo" type="button" class="btn btn-primary float-right" @click.prevent="counting(m)" ><i class=""></i>ჩარიცხვა</button>
                </div>
            </div>
