<template lang="">
    ...
    <!-- <section class="content ">
        ...
        <candidate_table :data="candidate" :role_id="data.role_id" :hrId="data.hr_id" :key="candidate.length"></candidate_table>
        <div class="mt-2">
            <paginate
...
export default {
    ...
    methods: {
        ...
        async filter(m){
            ...
            axios({
                    method: "post",
                    url: '/candidate_filter?page=' + this.pagination.current_page,
                    data: m,
