<template lang="">
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-xl-4 col-lg-6 col-md-12">
                    ...
                    <input
                        class="form-control"
                        v-model="m.user.name_ka"
                        type="text"
                        :placeholder="
                            $t('lang.employer_add_job_vacancy_name_placeholder')
                        "
                    />
                </div>
                <div class="col-xl-4 col-lg-6 col-md-12">
            ...
            <div class="p-a20 my-3">
                <h6 class="m-a0">
                    <i class="fa fa-user"></i> პირადი ინფორმაცია
                </h6>
            </div>
            <hr />
            <div class="row">
            ...
            <div class="row mt-4">
                ...
                <div class="col-xl-4 col-lg-6 col-md-12">
                    <div class="form-check">
                        ...
                        />
                        <label class="form-check-label" for="exampleCheck1"
                            >იმუშავებდით საზღვარგარეთ</label
                        >
                    </div>
                </div>
            </div>
        ...
        <div class="card-footer">
            ...
            <div class="col-md-12 d-flex justify-content-between">
                <button
                    ...
                    @click="openUpdateLanguageModal(m.get_language)"
                >
                    <i class=""></i>უცხო ენა
                </button>
                <button
                    ...
                    class="btn btn-primary"
                    @click="
                        openUpdateGeneralWorkModal(
                            m.get_general_work_experience
                        )
                    "
                >
                    <i class=""></i>ზოგადი სამუშაო გამოცდილება
                </button>
                <button
                    type="button"
                    class="btn btn-primary"
                    @click="openUpdateFamilyWorkModal(m.family_work_experience)"
                >
                    <i class=""></i>ოჯახში მუშაობა
                </button>
                <button
                    type="button"
                    class="btn btn-primary"
                    @click="
                        openUpdateWorkInformationModal(m.get_work_information)
                    "
                >
                    <i class=""></i>სამუშაო ინფორმაცია
                </button>
                <button
                    type="button"
                    class="btn btn-primary"
                    @click="openUpdateRecommendationModal(m.get_recommendation)"
                >
                    <i class=""></i>რეკომენდაცია
                </button>
                <button
                    type="button"
                    class="btn btn-primary"
                    @click="openUpdateNumberModal(m.number)"
                >
                    <i class=""></i>ნომრები
                </button>
                <button
                    type="button"
                    class="btn btn-primary"
                    @click="openUpdateNoticeModal(m.get_notice)"
                >
                    <i class=""></i>საბუთები
                </button>
            </div>
    ...
    <update_language_modal
        :visible="updateLanguageModal"
        :items="item"
    ></update_language_modal>
    <update_general_work_modal
        :visible="updateGeneralWorkModal"
        :items="item"
    ></update_general_work_modal>
    <update_work_information_modal
        :visible="updateWorkInformationModal"
        :items="item"
    ></update_work_information_modal>
    <update_family_work_modal
        :visible="updateFamilyWorkModal"
        :items="item"
    ></update_family_work_modal>
    <update_number_modal
        :visible="updateNumberModal"
        :items="item"
    ></update_number_modal>
    <update_recommendation_modal
        :visible="updateRecommendationModal"
        :items="item"
    ></update_recommendation_modal>
    <update_notice_modal
        :visible="updateNoticeModal"
        :items="item"
    ></update_notice_modal>
</template>
<script>
...
export default {
    ...
    created() {
        ...
        this.data.candidate.convection =
            this.data.candidate.convection == 1 ? true : 0;
        this.data.candidate.work_abroad =
            this.data.candidate.work_abroad == 1 ? true : 0;
    ...
    methods: {
        ...
        openUpdateLanguageModal(item) {
            ...
            this.item = {
                ...
                item: item,
                cla: {
                    languages: this.cla.languages,
                    languageLevels: this.cla.languageLevels,
                },
            };
        },
        ...
        openUpdateNumberModal(item) {
            ...
            this.item = {
                ...
                item: item,
                cla: {
                    numberOwner: this.cla.numberOwner,
                    numberCode: this.cla.numberCode,
                },
            };
        },
        openUpdateNoticeModal(item) {
            ...
            this.item = {
                candidate_id: this.data.candidate.id,
                item: item,
                cla: { notice: this.cla.notices },
                user_id: this.data.candidate.user_id,
            };
        },
    },
};
