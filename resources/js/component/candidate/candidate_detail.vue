    ...
    <div class="section-full p-t120 p-b90 bg-white">
        <div class="container">
                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-lg-8 col-md-12">
                        ...
                        <div class="cabdidate-de-info">
                            <div
                                class="twm-candi-self-wrap overlay-wraper"
                                :style="{
                                    backgroundImage:
                                        'url(' + backgroundImage + ')',
                                }"
                                ...
                                <div class="tw-sidebar-tags-wrap">
                                    <div class="tagcloud">
                                        <a
                                            ...
                                            >{{ item[`name_${getLang}`] }}</a
                                        >
                                    </div>
                                </div>
                            </div>
                            <div v-if="data.family_work_experience">
                                ...
                                <div class="twm-timing-list-wrap">
                                    <div class="twm-timing-list">
                                        <div
                                            v-if="
                                                data.family_work_experience &&
                                                data.family_work_experience
                                                    .experience == 1
                                            "
                                            class="twm-time-list-discription"
                                        >
                                            <p>
                                                მიმუშავია
                                                {{
                                                ...
                                                <b
                                                    ...
                                                    :key="index"
                                                    >{{ item }}</b
                                                >, მაქვს ოჯახში მუშაობის სტაჟი:
                                                {{
                                                    data.family_work_experience
                                                        .work_experience[
                                                        `name_${getLang}`
                                                    ]
                                                }}, აქედან ყველაზე ხანგრძლივად
                                                ერთ ოჯახში მუშაობის სტაჟი:
                                                {{
                                                    data.family_work_experience
                                                        .longest[
                                                        `name_${getLang}`
                                            ...
                                            <p>
                                                მევალებოდა:
                                                {{
                                                    data.family_work_experience.get_family_work_duty
                                                        .map(
                                                            (i) =>
                                                                i.duty[
                                                                    `name_${getLang}`
                            ...
                            <div v-if="data.general_work_experience.length > 0">
                                <h4 class="twm-s-title">
                                ...
                                <div class="twm-timing-list-wrap">
                                    <div
                                        v-if="
                                            data.general_work_experience
                                                .length > 0
                                        "
                                        class="twm-timing-list"
                                        v-for="(
                                            item, index
                                        ) in data.general_work_experience"
                                        :key="index"
                                    >
                                        <div class="twm-time-list-date">
                                            {{ item[`name_${getLang}`] }}
            ...
            <like_dont_like_candidate
                v-if="showButton"
                :id="data.qualifying_candidate[0].id"
            />
        </div>
    </div>
</template>
...
export default {
    ...
    setup(props) {
        ...
        const showButton = computed(() => {
            ...
            let extractedPart = pathName.match(
                /\/employer\/photo_questionnaire/
            );
