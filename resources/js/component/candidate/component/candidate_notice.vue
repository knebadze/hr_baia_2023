    ...
    <div class="panel panel-default">
        <div class="panel-heading wt-panel-heading p-a20">
            <h4 class="panel-tittle m-a0">
                {{ $t("lang.user_profile_page_references_title") }}
            </h4>
        </div>
            ...
            <div class="row">
                <div class="col-xl-6 col-lg-6 col-md-12">
                    <div class="form-group">
                        <label>{{
                            $t("lang.user_profile_page_references_name_notice")
                        }}</label>
                ...
                <div class="col-xl-6 col-lg-6 col-md-12">
                    <div class="form-group">
                        <label
                            >{{
                                $t("lang.user_profile_page_references_file")
                            }}
                            (PDF ფორმატში)</label
                        >
                        <div class="ls-inputicon-box">
                            <input
                                ...
                                :placeholder="
                                    $t(
                                        'lang.user_profile_page_medical_please_info'
                                    )
                                "
                            />
                        </div>
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="text-right">
                        ...
                        >
                            {{
                                $t(
                                    "lang.user_profile_page_references_button_add_info"
                                )
                            }}
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th>
                                            {{
                                                $t(
                                                    "lang.user_profile_page_references_reference"
                                                )
                                            }}
                                        </th>
                                        <th>
                                            {{
                                                $t(
                                                    "lang.user_profile_page_references_file"
                                                )
                                            }}
                                        </th>
                                        <th>
                                            {{
                                                $t(
                                                    "lang.user_profile_page_references_action"
                                                )
                                            }}
                                        </th>
                                    </tr>
...
export default {
    ...
    setup(props, { emit }) {
        ...
        const filterNotice = () => {
            ...
            cla.value.notices = props.data.cla.notices.filter(
        ...
        const add = (item) => {
            ...
            if (
                m.value.length > 0 &&
                data.notice.id != 6 &&
                m.value.some((element) => element.notice.id === item.notice.id)
            ) {
                toast.warning(
                    "ცნობა უკვე ატვირთულია შესაცვლელად წაშალეთ ძველი ცნობა",
                    {
                        theme: "colored",
                        autoClose: 1000,
                    }
        ...
        const validateAndSubmit = (formData, data) => {
            axios
                .post("/add_candidate_file", formData)
